...
/// {@category Models}
///
class WKConversationResult {
  late String? nextSeq;
  late bool? isFinished;
  List<WKUIConversationMsg>? conversationList = List.empty(growable: true);

  WKConversationResult({
    this.nextSeq,
    this.isFinished,
  ...
  //     data['conversation_list_result_conv_list'] =
  ...
  // String toLogString() {
  //   String res =
  //       "nextSeq:$nextSeq|isFinished:$isFinished|conversationList:${json.encode(conversationList?.map((e) => e?.toLogString()).toList())}";
  //   return res;
  // }
}
